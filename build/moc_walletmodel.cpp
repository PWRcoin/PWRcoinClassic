...
static const uint qt_meta_data_WalletModel[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::ULongLong, QMetaType::LongLong, QMetaType::ULongLong, QMetaType::ULongLong,    3,    4,    5,    6,
...
void WalletModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->balanceChanged((*reinterpret_cast< quint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2])),(*reinterpret_cast< quint64(*)>(_a[3])),(*reinterpret_cast< quint64(*)>(_a[4]))); break;
        ...
        {
            using _t = void (WalletModel::*)(quint64 , qint64 , quint64 , quint64 );
...
// SIGNAL 0
void WalletModel::balanceChanged(quint64 _t1, qint64 _t2, quint64 _t3, quint64 _t4)
{
