...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount = new pwrcoinAmountField(SendCoinsEntry);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. PWRcoinfwYhBmGXcFP2Po1NpRUEiK8km2)", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
