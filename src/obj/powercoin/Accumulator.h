 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the Powercoin library.
 *
...
public:
	 ...
	 * @throw      Powercoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		Powercoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A PowercoinException if the accumulator value is invalid.
	//  */
