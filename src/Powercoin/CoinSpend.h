 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the Powercoin library.
 *
...
/** The complete proof needed to spend a Powercoin.
...
public:
	...
	/**Generates a proof spending a Powercoin.
	 *
	 ...
	 * @throw PowercoinException if the process fails
	 */
