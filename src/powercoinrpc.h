...
#ifndef _PWRCOINRPC_H_
#define _PWRCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // powercoin is not connected
...
/**
 * powercoin RPC command dispatcher.
 */
class CRPCTable
{
private:
