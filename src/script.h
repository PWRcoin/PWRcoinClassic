...
#ifndef H_PWRCOIN_SCRIPT
#define H_PWRCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CpowercoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, powercoin always counted CHECKMULTISIGs
