 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the PWRcoin library.
 *
...
public:
	 ...
	 * @throw      PWRcoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		PWRcoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A PWRcoinException if the accumulator value is invalid.
	//  */
