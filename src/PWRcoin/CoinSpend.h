 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the PWRcoin library.
 *
...
/** The complete proof needed to spend a PWRcoin.
...
public:
	...
	/**Generates a proof spending a PWRcoin.
	 *
	 * To use this, provide an unspent PrivateCoin, the latest Accumulator
	 * (e.g from the most recent pwrcoin block) containing the public part
	 ...
	 * @param m arbitrary meta data related to the spend that might be needed by pwrcoin
	 * 			(i.e. the transaction hash)
	 * @throw PWRcoinException if the process fails
	 */
