...
/**
  pwrcoin GUI main class. This class represents the main window of the pwrcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class pwrcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit pwrcoinGUI(QWidget *parent = 0);
    ~pwrcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a pwrcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
