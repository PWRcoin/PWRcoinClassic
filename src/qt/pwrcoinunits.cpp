...
pwrcoinUnits::pwrcoinUnits(QObject *parent):
...
bool pwrcoinUnits::valid(int unit)
{
    switch(unit)
    {
    case PWR:
...
QString pwrcoinUnits::name(int unit)
{
    switch(unit)
    {
...
QString pwrcoinUnits::description(int unit)
{
    switch(unit)
    {
...
int pwrcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
...
int pwrcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case PWR: return 8;
...
int pwrcoinUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant pwrcoinUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
