...
/** pwrcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class pwrcoinUnits: public QAbstractListModel
{
public:
    explicit pwrcoinUnits(QObject *parent);
    ...
    static quint64 factor(int unit);
...
typedef pwrcoinUnits::Unit pwrcoinUnit;
