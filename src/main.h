...
#ifndef PWRCOIN_MAIN_H
#define PWRCOIN_MAIN_H
...
static const uint256 hashGenesisBlock("0x00000797a80081120690aab141f2da64c1af2e10dfe2791341ce21d27a97b84e");
static const uint256 hashGenesisBlockTestNet("0x0000785e0e2216952ec2137b3cbec50932aab18acbe35741cc5be37d78f69dee");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 10 * 60; } // up to 10 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 10 * 60; } // up to 10 minutes from the future


extern libPWRcoin::Params* ZCParams;
...
public:
    ...
    {
        // pwrcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of pwrcoins spent by this transaction.
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // pwrcoin: get transaction coin age
...
public:
    ...
    // pwrcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // pwrcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // pwrcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // pwrcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // pwrcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // pwrcoin: block index flags
    enum  
    {
