...
extern libPowercoin::Params* ZCParams;
...
public:
    ...
    {
        // powercoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of powercoins spent by this transaction.
    ...
    /** Amount of powercoins coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // powercoin: get transaction coin age
...
public:
    ...
    // powercoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // powercoin: two types of block: proof-of-work or proof-of-stake
    ...
    // powercoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // powercoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // powercoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // powercoin: block index flags
    enum  
    {
